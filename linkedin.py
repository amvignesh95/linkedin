...
class UserProfile:
    ...
    def insert_details(self,profile_id,first_name,last_name,email_id,degree,major_sub,college,joining_date,end_date,skill,language,proficiency_level,company_name,position,month,year):
        try:
            client = MongoClient()
